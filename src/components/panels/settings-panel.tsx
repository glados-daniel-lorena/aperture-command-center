...
const categoryLabels: Record<string, { label: string; icon: string; description: string }> = {
  general: { label: 'General', icon: '⚙', description: 'Core Aperture Command Center settings' },
    ...
    <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Configure Aperture Command Center behavior and retention policies</p>
        </div>
